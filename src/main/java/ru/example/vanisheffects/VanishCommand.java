...
/**
 * /v fire      [игрок]  — приглушённый огонь + звук телепортации, затем ваниш
 * /v bats      [игрок]  — настоящие летучие мыши, затем ваниш
 * /v lightning [игрок]  — серия молний, затем ваниш
 * /v show      [игрок]  — вернуть видимость (без эффектов)
 */
